...
Status: **plan final and approved; stages 1 to 4 done** (see DECISIONS.md), waiting for the user's go-ahead for stage 5. The user says "go" per step (see the prompt they keep for it). This file is
