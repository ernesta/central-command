...
Status: **plan final and approved; stages 1 to 3 done** (see DECISIONS.md), waiting for the user's go-ahead for stage 4. The user says "go" per step (see the prompt they keep for it). This file is
