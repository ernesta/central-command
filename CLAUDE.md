...
- Next feature: Meetings. It is planned in `docs/MEETINGS_PLAN.md`. Stages 1 to 3 (shared notes machinery,
  main-process core, TODO/topic/carry-over rules) are done and have no UI yet; stage 4 (the meeting page) waits
